...
Es8311AudioCodec::Es8311AudioCodec(void* i2c_master_handle, i2c_port_t i2c_port, int input_sample_rate, int output_sample_rate,
    ...
    gpio_num_t pa_pin, uint8_t es8311_addr, bool use_mclk, bool pa_inverted, int input_gain) {
    duplex_ = true; // 是否双工
    ...
    input_gain_ = input_gain; // ES8311 MIC PGA: 0-42dB (шаг 6dB), по умолчанию 30dB
